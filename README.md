...
Процесс извлечения полезной информации от заинтересованных сторон или из других источников.

## 2.1 Подготовка к выявлению
Этот шаг определяет план действий по выявлению требований.
В данном проекте было решено проводить встречу с клиентом каждую пятницу, чтобы докладывать о результатах работы.

## 2.1 Проведение выявления
Непосредственно сам процесс выявления, входе интервью с клиентом был создан [Документ с бизнес-требованиями](https://docs.google.com/document/d/16Om_Limm1SX8DCQ45dKJP2O9h8eAJ3sJ/edit)
